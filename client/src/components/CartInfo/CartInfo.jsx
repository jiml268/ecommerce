...
export default function CartInfo() {
  ...
  const SaveClicked = async (e) => {
    const index = getAllCartItems.findIndex(
    ...
    const saveInfo = {
      ...
      userID: getUserId,
      cartID: getCartID,
      quantity: getAllCartItems[index].quantity,
    };
      ...
      {getAllCartItems && (
        <div className={css.produceSection}>
          ...
          {getAllCartItems.map((item, index) => {
            const imageindex = getAllCartImages.findIndex(
              (iteminfo) =>
            ...
            const showimage =
              imageindex >= 0
                ? window.location.origin +
                  `/images/${getAllCartImages[imageindex].imageName}`
                    ...
                    <div className={css.priceSection}>
                      ...
                      <div>
                        ...
                        <div className={css.cartButtons}>
                          ...
                          <button
                            type="button"
                            className={`${css.addtocart} ${css.incart}`}
                          >
                            {item.quantity}
                          </button>
                          ...
                          <button
                            ...
                            name="increase"
                            className={`${css.changeQnty} ${
                              item.quantity >= item.Stock ? css.hideButton : ""
                            }`}
                          >
                            {" "}
                            +
